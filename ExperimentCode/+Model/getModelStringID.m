...
switch lower(params.model)
    case 'is'
        name = sprintf('is_%dx%d_cinfo%.3f_sinfo%.3f_vs%.2f_pm%.2f_pC%.2f_vx%.2f_gam%.2f_nu%.2f_cu%.2f_fb%d_ns%d_noise%.2e_lapse%.2e', ...
            params.trials, params.frames, params.category_info, params.sensory_info, params.var_s, ...
            params.p_match, params.prior_C, params.var_x, params.gamma, params.updates, params.constant_update, params.fb_strength, params.samples, ...
            params.noise, params.lapse);
        if ~params.importance_norm
            name = [name '_unnorm'];
        end
    case 'is_parallel'
        name = sprintf('is_parallel_%dx%d_cinfo%.3f_sinfo%.3f_vs%.2f_pm%.2f_pC%.2f_vx%.2f_gam%.2f_nu%.2f_cu%.2f_fb%d_ns%d_noise%.2e_lapse%.2e_cognitiveload%.2e', ...
            params.trials, params.frames, params.category_info, params.sensory_info, params.var_s, ...
            params.p_match, params.prior_C, params.var_x, params.gamma, params.updates, params.constant_update, params.fb_strength, params.samples, ...
            params.noise, params.lapse, params.cognitive_load);
        if ~params.importance_norm
            name = [name '_unnorm'];
        end
    case 'is_race'
        name = sprintf('is_race_%dx%d_cinfo%.3f_sinfo%.3f_vs%.2f_pm%.2f_pC%.2f_vx%.2f_gam%.2f_nu%.2f_cu%.2f_fb%d_ns%d_noise%.2e_lapse%.2e_cognitiveload%.2e', ...
            params.trials, params.frames, params.category_info, params.sensory_info, params.var_s, ...
            params.p_match, params.prior_C, params.var_x, params.gamma, params.updates, params.constant_update, params.fb_strength, params.samples, ...
            params.noise, params.lapse, params.cognitive_load);
        if ~params.importance_norm
