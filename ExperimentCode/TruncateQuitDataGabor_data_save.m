function GaborData = TruncateQuitDataGabor_data_save(GaborData,point)
...
GaborData.true_ratio(point+1:end) = [];
GaborData.sign_noise(point+1:end) = [];
GaborData.sign_contrast(point+1:end) = [];
