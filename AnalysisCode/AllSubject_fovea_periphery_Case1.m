...
time(2) = 1/12;
expt_type = 2;
dir = 'RawDataFoveaPeripheryStimulusCase1';
subjects = {...
    'bpgFinaltest-subject19', 'bpgFinaltestPeriphery-subject02';%gabriel
    'bpgFinaltest-subject17', 'bpgFinaltestPeriphery-subject01';%grace
    'bpgFinaltest-subject20', 'bpgFinaltestPeriphery-subject03';%alexis
    'bpgFinaltest-subject21', 'bpgFinaltestPeriphery-subject04';%lucy
    'bpgFinaltest-subject22', 'bpgFinaltestPeriphery-subject05';%brenda
    'bpgFinaltest-subject18', 'bpgFinaltestPeriphery-subject06';%sarah
    'bpgFinaltest-subject25', 'bpgFinaltestPeriphery-subject07' %marty
    };

subjectsID_fovea = {...
    'bpgFinaltest-subject19';%gabriel
    'bpgFinaltest-subject17';%grace
    'bpgFinaltest-subject20';%alexis
    'bpgFinaltest-subject21';%lucy
    'bpgFinaltest-subject22';%brenda
    'bpgFinaltest-subject18';%sarah
    'bpgFinaltest-subject25' %marty
    };

subjectsID_periphery = {...
    'bpgFinaltestPeriphery-subject02';%gabriel
    'bpgFinaltestPeriphery-subject01';%grace
    'bpgFinaltestPeriphery-subject03';%alexis
    'bpgFinaltestPeriphery-subject04';%lucy
    'bpgFinaltestPeriphery-subject05';%brenda
    'bpgFinaltestPeriphery-subject06';%sarah
    'bpgFinaltestPeriphery-subject07' %marty
    };
...
[best_hprs_fovea] = CustomRegression.combined_hprs_search_foveal_periphery_stimulus(subjectsID_fovea, expt_type, hpr_ridge, hpr_ar1, hpr_curvature, standardize, folds, dir);
disp('Starting to find best hyperparameters for PERIPHERAL data across subjects....');
[best_hprs_periphery] = CustomRegression.combined_hprs_search_foveal_periphery_stimulus(subjectsID_periphery, expt_type, hpr_ridge, hpr_ar1, hpr_curvature, standardize, folds, dir);
...
for i=1:(num_sub)
    ...
    suptitle(['Top Row: Foveal Frames and Bottom Row: Peripheral Frames for Subject ' num2str(i)])
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
close all;
filename_save = strcat('SavedWorkspace/FoveaPeripheryCase1_',date,'.mat');
save(filename_save);
