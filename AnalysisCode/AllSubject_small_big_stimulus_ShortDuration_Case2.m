...
time(2) = 1/12;
expt_type = 2;
dir = 'RawDataSmallBigStimulusCase2';
subjects = {...
    'bpgshorterframes-subject03', 'bpgshorterframesbiggerstim-subject01';...
    'bpgshorterframes-subject04', 'bpgshorterframesbiggerstim-subject02';
    'bpgshorterframes-subject05', 'bpgshorterframesbiggerstim-subject04'
    };
subjectsID_small = {...
...
subjectsID_big = {...
    'bpgshorterframesbiggerstim-subject01';...
    'bpgshorterframesbiggerstim-subject02';
    'bpgshorterframesbiggerstim-subject04'
    };
...
for i=1:(num_sub)
    ...
    sgtitle(['Top Row: Small Stimuli and Bottom Row: Big Stimuli for Subject ' num2str(i)],'fontsize',30);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
close all;
filename_save = strcat('SavedWorkspace/SmallBigCase2_',date,'.mat');
save(filename_save);
