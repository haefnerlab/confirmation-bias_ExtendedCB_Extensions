...
time(2) = 1/12;
expt_type = 2;
dir = 'RawDataFoveaPeripheryStimulusCase2';
subjects = {...
    'bpgFinaltest-subject19', 'bpgBiggestAnnulus-subject03';%gabriel
    'bpgFinaltest-subject17', 'bpgBiggestAnnulus-subject07';%grace
    'bpgFinaltest-subject26', 'bpgBiggestAnnulus-subject05';%katherine
    'bpgFinaltest-subject21', 'bpgBiggestAnnulus-subject01';%lucy
    'bpgFinaltest-subject22', 'bpgBiggestAnnulus-subject06';%brenda
    'bpgFinaltest-subject18', 'bpgBiggestAnnulus-subject04';%sarah
    'bpgFinaltest-subject25', 'bpgBiggestAnnulus-subject02' %marty
    };
subjectsID_fovea = {...
    'bpgFinaltest-subject19';%gabriel
    'bpgFinaltest-subject17';%grace
    'bpgFinaltest-subject26';%katherine
...
subjectsID_periphery = {...
    'bpgBiggestAnnulus-subject03';%gabriel
    'bpgBiggestAnnulus-subject07';%grace
    'bpgBiggestAnnulus-subject05';%katherine
    'bpgBiggestAnnulus-subject01';%lucy
    'bpgBiggestAnnulus-subject06';%brenda
    'bpgBiggestAnnulus-subject04';%sarah
    'bpgBiggestAnnulus-subject02' %marty
    };
...
[best_hprs_periphery] = CustomRegression.combined_hprs_search_peripheral_stimulusCase2(subjectsID_periphery, image_array_pre, ratios, contrasts, expt_type, hpr_ridge, hpr_ar1, hpr_curvature, standardize, folds, dir);
...
for i=1:(num_sub)
    ...
    for j=1:cases
        if j==1
            ...
            [params_boot,sobl,abbl_exp,trials,bin_centers,~,~,data,frame_signals,sobl_time_locked,log_bernoulli_sub{i,j}] = run_analysis_noise_only_big_stimCase2(subjects{i,j},expt_type,time(j),boots,best_hprs,image_array_pre,ratios,contrasts,standardize,dir);
        end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
close all;
filename_save = strcat('SavedWorkspace/FoveaPreipheryCase2_',date,'.mat');
save(filename_save);
