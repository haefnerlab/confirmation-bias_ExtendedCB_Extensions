function [best_hprs] = combined_hprs_search_peripheral_stimulus(subjectID, correct_signals_pre, faulty_signals_pre, ratios, contrasts, expt_type, hpr_ridge, hpr_ar1, hpr_curvature, standardize, folds, dir)
% initialize
datadir = fullfile(pwd, dir);
[num_sub,~] = size(subjectID);
trial_types = 10; % this is fixed from PreGen
for sub =1:num_sub
