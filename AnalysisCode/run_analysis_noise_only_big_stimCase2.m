function [params_boot,sobl,abbl,trials,bin_centers,means,stderrs,data,frame_signals,sobl_time_locked,log_bernoulli] = run_analysis_noise_only_big_stimCase2(subjectID, expt_type, time, boot_n, best_hprs, image_array_pre, ratios, contrasts, standardize, dir)
